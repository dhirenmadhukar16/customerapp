  ...
  void _submitComplaint() async {
    ...
    try {
      ...
      if (!_isValidUuid(orderId)) {
        throw Exception(
          'Use the real order ID (UUID), not the order number such as WF-... or #1233344.',
        );
      }
      ...
      if (mounted) {
        ...
        widget.onComplaintCreated?.call();
              ...
              TextFormField(
                ...
                validator: (value) {
                  ...
                  if (!_isValidUuid(value!)) {
                    return 'Use the real order ID (UUID), not the order number';
                  }
                  return null;
                },
              ),
